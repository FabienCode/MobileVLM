...
case ${TASK} in
    ...
    "pretrain")
        ...
        deepspeed --include localhost:1,5,7 mobilevlm/train/train_mem.py \
            ...
            --version plain \
            --data_path /data/hym/project/VLMs/MobileVLM/data/pretrain_data/share-captioner_coco_lcs_sam_1246k_1107.json \
            --image_folder /data/hym/project/VLMs/MobileVLM/data/pretrain_data \
    ...
    "finetune")
        ...
        deepspeed --include localhost:1,5,7 mobilevlm/train/train_mem.py \
            ...
            --version v1 \
            --data_path /data/hym/project/VLMs/MobileVLM/data/finetune_data/MobileVLM_V2_FT_Mix2M.json \
            --image_folder /data/hym/project/VLMs/MobileVLM/data/finetune_data \
            --vision_tower ${VISION_MODEL} \
            --vision_tower_type clip \
            --mm_projector_type ldpnetv2 \
            --mm_vision_select_layer -2 \
